#ifndef VIFCOPULA_DISTRIBUTION_BICOP_INDEPENDENCE_LOG_CPP
#define VIFCOPULA_DISTRIBUTION_BICOP_INDEPENDENCE_LOG_CPP
...
#endif // VIFCOPULA_DISTRIBUTION_BICOP_INDEPENDENCE_LOG_CPP
