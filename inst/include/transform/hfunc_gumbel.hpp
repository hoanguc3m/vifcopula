#ifndef VIFCOPULA_HFUNC_GUMBEL_HPP
#define VIFCOPULA_HFUNC_GUMBEL_HPP
...
/**
 * The Conditional Distribution Function of a Bivariate Gumbel Copula
 ...
 * @param theta (Sequence of) parameters for the Gumbel copula
 * @return The Conditional Distribution Function of a bivariate Gumbel Copula of u given v
...
inline
T_u hfunc_gumbel(const T_u& u, const T_v& v, const T_theta& theta)
{
    static const char* function("vifcopula::hfunc_gumbel");
...
//      check_bounded(function, "Correlation parameter", theta, -1,1);
    ...
    for (size_t n = 0; n < N; n++)
    {
        ...
        double inv_theta = 1/theta_value;

        double t_u = pow(-log(u_val), theta_value);
...
#endif // VIFCOPULA_HFUNC_GUMBEL_HPP
