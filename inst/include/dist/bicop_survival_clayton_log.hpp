#ifndef VIFCOPULA_DISTRIBUTION_BICOP_SURVIVAL_CLAYTON_LOG_HPP
#define VIFCOPULA_DISTRIBUTION_BICOP_SURVIVAL_CLAYTON_LOG_HPP
...
using namespace stan;
    ...
    /**
     * The log of the bivariate SURVIVAL Clayton copula density for the specified vector(s) u
    ...
    bicop_survival_clayton_log(const T_u& u, const T_v& v, const T_theta& theta) {
      static const char* function("vifcopula::bicop_survival_clayton_log");
...
//      check_positive_finite(function, "dependence parameter", theta);
    ...
    typename stan::return_type<T_u, T_v, T_theta>::type
        bicop_survival_clayton_log(const T_u& u, const T_v& v, const T_theta& theta) {
      return bicop_survival_clayton_log<false>(u, v, theta);
    }

}
#endif // VIFCOPULA_DISTRIBUTION_BICOP_SURVIVAL_CLAYTON_LOG_HPP
