#ifndef VIFCOPULA_DISTRIBUTION_BICOP_R90_CLAYTON_LOG_HPP
#define VIFCOPULA_DISTRIBUTION_BICOP_R90_CLAYTON_LOG_HPP
...
using namespace stan;
    ...
    /**
     * The log of the bivariate rotated 90 degree Clayton copula density for the specified vector(s) u
    ...
    bicop_r90_clayton_log(const T_u& u, const T_v& v, const T_theta& theta) {
      static const char* function("vifcopula::bicop_r90_clayton_log");
...
//      check_positive_finite(function, "dependence parameter", theta);
    ...
    typename stan::return_type<T_u, T_v, T_theta>::type
    bicop_r90_clayton_log(const T_u& u, const T_v& v, const T_theta& theta) {
      return bicop_r90_clayton_log<false>(u, v, theta);
    }

}
#endif // VIFCOPULA_DISTRIBUTION_BICOP_R90_CLAYTON_LOG_HPP
