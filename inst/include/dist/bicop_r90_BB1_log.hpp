#ifndef VIFCOPULA_DISTRIBUTION_BICOP_R90_BB1_LOG_HPP
#define VIFCOPULA_DISTRIBUTION_BICOP_R90_BB1_LOG_HPP
...
using namespace stan;
    ...
    /**
     * The log of the bivariate rotated 90 degree BB1 copula density for the specified vector(s) u
    ...
    bicop_r90_BB1_log(const T_u& u, const T_v& v, const T_theta& theta, const T_delta& delta) {
      static const char* function("vifcopula::bicop_r90_BB1_log");
...
//      check_bounded(function, "dependence parameter", delta,0,1);
      ...
      for (size_t n = 0; n < N; n++) {
        T_partials_return u_dbl = 1. - value_of(u_vec[n]);        // Rotate 90 degree
    ...
    typename stan::return_type<T_u, T_v, T_theta, T_delta>::type
    bicop_r90_BB1_log(const T_u& u, const T_v& v, const T_theta& theta, const T_delta& delta) {
      return bicop_r90_BB1_log<false>(u, v, theta, delta);
    }

}
#endif // VIFCOPULA_DISTRIBUTION_BICOP_R90_BB1_LOG_HPP
