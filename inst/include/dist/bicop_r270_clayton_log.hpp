#ifndef VIFCOPULA_DISTRIBUTION_BICOP_R270_CLAYTON_LOG_HPP
#define VIFCOPULA_DISTRIBUTION_BICOP_R270_CLAYTON_LOG_HPP
...
using namespace stan;
    ...
    /**
     * The log of the bivariate rotated 270 degree Clayton copula density for the specified vector(s) u
    ...
    bicop_r270_clayton_log(const T_u& u, const T_v& v, const T_theta& theta) {
      static const char* function("vifcopula::bicop_r270_clayton_log");
...
//      check_positive_finite(function, "dependence parameter", theta);
      ...
      for (size_t n = 0; n < N; n++) {
        T_partials_return u_dbl = value_of(u_vec[n]);        //
        T_partials_return v_dbl = 1 - value_of(v_vec[n]);        // Rotate 270 degree
    ...
    typename stan::return_type<T_u, T_v, T_theta>::type
    bicop_r270_clayton_log(const T_u& u, const T_v& v, const T_theta& theta) {
      return bicop_r270_clayton_log<false>(u, v, theta);
    }

}
#endif // VIFCOPULA_DISTRIBUTION_BICOP_R270_CLAYTON_LOG_HPP
