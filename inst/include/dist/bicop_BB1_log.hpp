#ifndef VIFCOPULA_DISTRIBUTION_BICOP_BB1_LOG_HPP
#define VIFCOPULA_DISTRIBUTION_BICOP_BB1_LOG_HPP
...
using namespace stan;
    ...
    /**
     * The log of the bivariate BB1 copula density for the specified vector(s) u
    ...
    bicop_BB1_log(const T_u& u, const T_v& v, const T_theta& theta, const T_delta& delta) {
      static const char* function("vifcopula::bicop_BB1_log");
...
//      check_bounded(function, "dependence parameter", delta,0,1);
    ...
    typename stan::return_type<T_u, T_v, T_theta, T_delta>::type
    bicop_BB1_log(const T_u& u, const T_v& v, const T_theta& theta, const T_delta& delta) {
      return bicop_BB1_log<false>(u, v, theta, delta);
    }

}
#endif // VIFCOPULA_DISTRIBUTION_BICOP_BB1_LOG_HPP
