...
#ifndef VIFCOPULA_NEST_SELECT_FACTOR_COP_STANC_HPP
#define VIFCOPULA_NEST_SELECT_FACTOR_COP_STANC_HPP
...
class neselefcopula : public prob_grad
{
private:
...
public:
    ...
    neselefcopula(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "vifcopula::neselefcopula";
    ...
    */
    ...
    neselefcopula(const matrix_d& u_, const vector<int>& gid_,
        ...
        : prob_grad(0)
    {
        typedef boost::ecuyer1988 rng_t;
        rng_t base_rng(0);  // 0 seed default
        neselefcopula(u_, gid_, copula_type_,
                  latent_copula_type_,
                  t_max_, n_max_, k_,
                  base_rng, pstream__);
    }
    ...
    {
        static const char* function = "vifcopula::neselefcopula";
    ...
    void set_gid(vector<int> gid_){
        gid = gid_;             // Group of copula
    }
...
//typedef vifcopula::neselefcopula stan_model;
#endif // VIFCOPULA_NEST_SELECT_FACTOR_COP_STANC_HPP
