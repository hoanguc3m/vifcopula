...
#ifndef VIFCOPULA_BI_FACTOR_COP_HPP
#define VIFCOPULA_BI_FACTOR_COP_HPP
...
class bifcopula : public prob_grad
{
private:
...
public:
    ...
    bifcopula(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "vifcopula::bifcopula";
        ...
        pos__ = 0;
        size_t latent_copula_type_limit_0__ = n_max;
        ...
        num_params_r__ += count_params(latent_copula_type);
    ...
    */
    ...
    bifcopula(const matrix_d& u_, const vector<int>& gid_,
        ...
        : prob_grad(0)
    {
        typedef boost::ecuyer1988 rng_t;
        rng_t base_rng(0);  // 0 seed default
        bifcopula(u_, gid_, copula_type_,
                  latent_copula_type_,
                  t_max_, n_max_, k_,
                  base_rng, pstream__);
    }
    ...
    {
        static const char* function = "vifcopula::bifcopula";
    ...
    int get_eff_para(void){
        ...
        eff_para += count_params(latent_copula_type);
        return eff_para;
    }
    int get_t_max(void){
        return t_max;
...
//typedef vifcopula::bifcopula stan_model;
#endif // VIFCOPULA_BI_FACTOR_COP_HPP
