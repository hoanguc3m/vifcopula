...
#ifndef VIFCOPULA_FACTOR_VINE_COP_HPP
#define VIFCOPULA_FACTOR_VINE_COP_HPP
...
class fvcopula : public prob_grad
{
private:
...
public:
    ...
    fvcopula(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "vifcopula::fvcopula";
        ...
        context__.validate_dims("data initialization", "vine_copula_type", "int", context__.to_vec(n_max));
        validate_non_negative_index("vine_copula_type", "n_max", n_max);
            vine_copula_type = std::vector<int>(max(gid),int(0));
        vals_i__ = context__.vals_i("vine_copula_type");
        pos__ = 0;
        size_t vine_copula_type_limit_0__ = n_max;
        for (size_t i_0__ = 0; i_0__ < vine_copula_type_limit_0__; ++i_0__) {
            vine_copula_type[i_0__] = vals_i__[pos__++];
        }
    ...
    */
    ...
    fvcopula(const matrix_d& u_, const vector<int>& gid_,
    ...
    {
        static const char* function = "vifcopula::fvcopula";
                 ...
                 std::ostream* pstream__ = 0) const
    {
        ...
        Eigen::Matrix<T__,Eigen::Dynamic,1>  theta_vine(vine_copula_type.size());
        (void) theta_vine;  // dummy to suppress unused var warning

        Eigen::Matrix<T__,Eigen::Dynamic,1>  theta2_vine(vine_copula_type.size());
        (void) theta2_vine;  // dummy to suppress unused var warning
        stan::math::initialize(theta2_vine, DUMMY_VAR_ZERO__);
        stan::math::fill(theta2_vine,DUMMY_VAR_ZERO__);
        ...
        try
        {
            ...
            for (int i = 0; i < vine_copula_type.size(); i++)
            {
                ...
                bicop_log_add<propto__,jacobian__,T__,T__,T__>(i, vine_copula_type, u1_cond_col, u2_cond_col, theta_vine, theta2_vine, lp__, lp_accum__, in__);
                     ...
                     std::ostream* pstream__ = 0) const
    {
        ...
        */
        ...
        for (int i = 0; i < vine_copula_type.size(); i++) {
            write_theta(i, vine_copula_type[i], in__, vars__);
        }
...
//typedef vifcopula::fvcopula stan_model;
#endif // VIFCOPULA_FACTOR_VINE_COP_HPP
