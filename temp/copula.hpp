...
private:
    ...
    int k;
    vector<int> gid;
    vector<int> copula_type;
public:
    one_factor_cop(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "vifcopula::one_factor_cop";
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        if (jacobian__)
            theta = in__.vector_lub_constrain(-(1),1,n_max,lp__);
        else
            theta = in__.vector_lub_constrain(-(1),1,n_max);
        ...
        try {
            ...
            lp_accum__.add(uniform_log<propto__>(theta, -(1), 1));
            current_statement_begin__ = 33;
            for (int j = 1; j <= n_max; ++j) {

                current_statement_begin__ = 34;
                lp_accum__.add(normal_log(col(u,j),0,get_base1(theta,j,"theta",1)));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e,current_statement_begin__);
            // Next line prevents compiler griping about no return
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (int k_0__ = 1; k_0__ <= n_max; ++k_0__) {
            param_name_stream__.str(std::string());
