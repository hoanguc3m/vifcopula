...
n_max = 100
k_max = 2
datagen_gauss <- fcopsim(t_max = t_max, n_max = n_max, k_max = k_max, family = 1, seed_num = 100)
...
par(mfrow =c(1,2))
par(mar=c(5,5,3,1))
plot(datagen$v[,1], vi_gauss$mean_iv[1:t_max], xlab = expression(v[t]), ylab = expression(v[approximated]))
abline(a= 0, b=1, col="red")
plot(datagen$theta[,1], vi_gauss$mean_iv[(t_max+1):(t_max+n_max)] , xlab = expression(theta[t]), ylab = expression(theta[approximated]))
abline(a= 0, b=1, col="red")
dev.off()

gauss_init <- matrix(1, nrow = n_max, ncol = k_max)
other <- list(seed = 126, core = 8, iter = 1000,
              n_monte_carlo_grad = 1, n_monte_carlo_elbo = 10,
              eval_elbo = 50, adapt_bool = T, adapt_val = 1,
...
sum(vi_gauss$cop_type[,2] == datagen_gauss$family[,2])
...
datagen_clayton <- fcopsim(t_max = 1000, n_max = 100, k_max = k_max, family = 3)
...
other <- list(seed = 126, core = 8, iter = 1000,
              n_monte_carlo_grad = 1, n_monte_carlo_elbo = 10,
              eval_elbo = 100, adapt_bool = T, adapt_val = 1,
              adapt_iterations = 50, tol_rel_obj = 0.3, copselect = F)
vi_clayton <- vifcopula::vifcop(data,init,other)

pdf(file='img/Clayton1.pdf', width = 9, height = 4.5)
par(mfrow =c(1,2))
par(mar=c(5,5,3,1))
plot(datagen$v[,1], vi_clayton$mean_iv[1:t_max], xlab = expression(v[t]), ylab = expression(v[approximated]))
abline(a= 0, b=1, col="red")
plot(datagen$theta[,1], vi_clayton$mean_iv[(t_max+1):(t_max+n_max)], xlab = expression(theta[t]), ylab = expression(theta[approximated]))
abline(a= 0, b=1, col="red")
dev.off()
...
################################################################################
datagen_gumbel <- fcopsim(t_max = 1000, n_max = 100, k_max = k_max, family = 4)
...
datagen_frank <- fcopsim(t_max = 1000, n_max = 100, k_max = k_max, family = 5)
...
datagen_joe <- fcopsim(t_max = 1000, n_max = 100, k_max = k_max, family = 6)
datagen <- datagen_joe
data <- list(u = datagen$u,
             n_max = datagen$n_max,
             t_max = datagen$t_max,
...
datagen_mix <- fcopsim(t_max = 1000, n_max = 100, k_max = k_max, family = copfamily)
datagen <- datagen_mix
data <- list(u = datagen$u,
             n_max = datagen$n_max,
             t_max = datagen$t_max,
